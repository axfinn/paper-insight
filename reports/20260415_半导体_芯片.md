...
### 1. Building reliable 3D photonic integrated circuits and cavities at the wafer scale

| 属性 | 内容 |
|------|------|
| **论文标题** | Building reliable 3D photonic integrated circuits and cavities at the wafer scale |
| **作者** | Yuhao Huang, Yunqi Fu, Yu Xia, Yuemin Li, Zheng Li 等 |
| **来源** | arXiv |
| **发表日期** | 2026-04-14 |
| **类别** | physics.optics |
...
[原文链接](http://arxiv.org/abs/2604.12889v1)

---

### 2. Low-confinement silicon nitride waveguides manufactured via direct glass bonding

| 属性 | 内容 |
|------|------|
| **论文标题** | Low-confinement silicon nitride waveguides manufactured via direct glass bonding |
| **作者** | Mikhail V. Tsvetkov, Dmitry V. Obydennov, Alexandr S. Rykov, Alexandr R. Shevchenko, Maxim V. Shibalov 等 |
| **来源** | arXiv |
| **发表日期** | 2026-04-14 |
| **类别** | physics.optics |
...
[原文链接](http://arxiv.org/abs/2604.12814v1)

---

### 3. High-Endurance, Low-loss Sb2Se3 Optical Switches on Silicon Nitride using Transparent Conductive Heaters

| 属性 | 内容 |
|------|------|
| **论文标题** | High-Endurance, Low-loss Sb2Se3 Optical Switches on Silicon Nitride using Transparent Conductive Heaters |
| **作者** | Xingshi Yu, Ipsita Chakraborty, Isaac Johnson, Savvas I. Raptis, Qianbin Luo 等 |
| **来源** | arXiv |
| **发表日期** | 2026-04-13 |
| **类别** | physics.optics |
...
[原文链接](http://arxiv.org/abs/2604.11649v1)

---

### 4. Multiplexed cryo-CMOS control of an isolated double quantum dot

| 属性 | 内容 |
|------|------|
| **论文标题** | Multiplexed cryo-CMOS control of an isolated double quantum dot |
| **作者** | Mathieu Darnas, Mathilde Ouvrier-Buffet, Antoine Faurie, Jean-Baptiste Casanova, Benoit Bertrand 等 |
| **来源** | arXiv |
| **发表日期** | 2026-04-13 |
| **类别** | cond-mat.mes-hall |
...
[原文链接](http://arxiv.org/abs/2604.11266v1)

---

### 5. Beyond Silicon: Materials, Mechanisms, and Methods for Physical Neural Computing

| 属性 | 内容 |
|------|------|
| **论文标题** | Beyond Silicon: Materials, Mechanisms, and Methods for Physical Neural Computing |
| **作者** | Stefan Fischer, Nihat Ay, Olaf Landsiedel, Esfandiar Mohammadi, Sebastian Otte 等 |
| **来源** | arXiv |
| **发表日期** | 2026-04-10 |
| **类别** | cs.NE, cs.ET |
...
[原文链接](http://arxiv.org/abs/2604.09833v1)

---

### 6. High-efficiency graphene-silicon slot-waveguide microring modulator at 1.5 μm and 2 μm wavelength bands

| 属性 | 内容 |
|------|------|
| **论文标题** | High-efficiency graphene-silicon slot-waveguide microring modulator at 1.5 μm and 2 μm wavelength bands |
| **作者** | Chao Luan, Deming Kong, Yong Liu, Yunhong Ding, Hao Hu |
| **来源** | arXiv |
| **发表日期** | 2026-04-09 |
| **类别** | physics.optics |
...
[原文链接](http://arxiv.org/abs/2604.08472v1)

---

### 7. Area Optimization of Open-Source Low-Power INA in 130nm CMOS using Hybrid Mixed-Variable PSO

| 属性 | 内容 |
|------|------|
| **论文标题** | Area Optimization of Open-Source Low-Power INA in 130nm CMOS using Hybrid Mixed-Variable PSO |
| **作者** | Avishka Herath, Chanula Luckshan, Lochana Katugaha, Udara Mendis, Kithmin Wickremasinghe |
| **来源** | arXiv |
| **发表日期** | 2026-04-05 |
| **类别** | eess.SY |
...
[原文链接](http://arxiv.org/abs/2604.04213v1)

---

### 8. Silicon Photonics-based Heterodyne Interferometric Imager for free-space imaging

| 属性 | 内容 |
|------|------|
| **论文标题** | Silicon Photonics-based Heterodyne Interferometric Imager for free-space imaging |
| **作者** | Humphry Chen, Mingye Fu, Shun-Hung Lee, Shelbe Timothy, Lawrence Shing 等 |
| **来源** | arXiv |
| **发表日期** | 2026-04-03 |
| **类别** | physics.optics, astro-ph.IM |
...
[原文链接](http://arxiv.org/abs/2604.03468v1)

---

### 9. Construction and characterisation of the DarkSide-20k veto silicon photo-multiplier tiles

| 属性 | 内容 |
|------|------|
| **论文标题** | Construction and characterisation of the DarkSide-20k veto silicon photo-multiplier tiles |
| **作者** | DarkSide-20k collaboration |
| **来源** | arXiv |
| **发表日期** | 2026-04-02 |
| **类别** | physics.ins-det, hep-ex |
...
[原文链接](http://arxiv.org/abs/2604.02551v1)

---

### 10. Quantum memory on a nanophotonic silicon chip

| 属性 | 内容 |
|------|------|
| **论文标题** | Quantum memory on a nanophotonic silicon chip |
| **作者** | Stephan Rinner, Jonas Schmitt, Kilian Sandholzer, Andreas Reiserer |
| **来源** | arXiv |
| **发表日期** | 2026-03-31 |
| **类别** | quant-ph, cond-mat.other |
...
[原文链接](http://arxiv.org/abs/2604.00138v1)

---

## 📊 行业洞察

本报告收录了 半导体/芯片 领域 10 篇最新学术论文，主要来源于 arXiv 等学术数据库。

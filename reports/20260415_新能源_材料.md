...
| 属性 | 内容 |
|------|------|
| **论文标题** | C2NP: A Benchmark for Learning Scale-Dependent Geometric Invariances in 3D Materials Generation |
| **作者** | Can Polat, Erchin Serpedin, Mustafa Kurban, Hasan Kurban |
| **来源** | arXiv |
| **发表日期** | 2026-01-27 |
| **类别** | cond-mat.mtrl-sci, cond-mat.mes-hall, cs.LG, quant-ph |
...
[原文链接](http://arxiv.org/abs/2601.19076v1)

---

### 2. Adsorption energies are necessary but not sufficient to identify good catalysts

| 属性 | 内容 |
|------|------|
| **论文标题** | Adsorption energies are necessary but not sufficient to identify good catalysts |
| **作者** | Shahana Chatterjee, Alexander Davis, Lena Podina, Divya Sharma, Yoshua Bengio 等 |
| **来源** | arXiv |
| **发表日期** | 2025-12-05 |
| **类别** | cond-mat.mtrl-sci, physics.chem-ph |
...
[原文链接](http://arxiv.org/abs/2512.05938v1)

---

### 3. Catalyst GFlowNet for electrocatalyst design: A hydrogen evolution reaction case study

| 属性 | 内容 |
|------|------|
| **论文标题** | Catalyst GFlowNet for electrocatalyst design: A hydrogen evolution reaction case study |
| **作者** | Lena Podina, Christina Humer, Alexandre Duval, Victor Schmidt, Ali Ramlaoui 等 |
| **来源** | arXiv |
| **发表日期** | 2025-10-02 |
...
[原文链接](http://arxiv.org/abs/2510.02142v1)

---

### 4. Catalytic activity of Al-Cu-Fe-Ni-Cr high entropy alloy

| 属性 | 内容 |
|------|------|
| **论文标题** | Catalytic activity of Al-Cu-Fe-Ni-Cr high entropy alloy |
...
[原文链接](http://arxiv.org/abs/2501.04516v1)

---

### 5. Platinum-Decorated Graphene: Experimental Insight into Growth Mechanisms and Hydrogen Adsorption Properties

| 属性 | 内容 |
|------|------|
| **论文标题** | Platinum-Decorated Graphene: Experimental Insight into Growth Mechanisms and Hydrogen Adsorption Properties |
| **作者** | Letizia Ferbel, Stefano Veronesi, Ylea Vlamidis, Antonio Rossi, Leonardo Sabattini 等 |
| **来源** | arXiv |
| **发表日期** | 2023-09-27 |
| **类别** | cond-mat.mtrl-sci |
...
[原文链接](http://arxiv.org/abs/2309.15637v1)

---

### 6. High Entropy Alloy Catalytic Action on MgH2 Hydrogen Storage Materials

| 属性 | 内容 |
|------|------|
| **论文标题** | High Entropy Alloy Catalytic Action on MgH2 Hydrogen Storage Materials |
| **作者** | S. K. Verma, S. S. Mishra, N. K. Mukhopadhyay, T. P. Yadav |
| **来源** | arXiv |
| **发表日期** | 2023-07-23 |
| **类别** | cond-mat.mtrl-sci |
...
[原文链接](http://arxiv.org/abs/2307.12240v1)

---

### 7. Exploring the Surface Segregation of Rh Dopant in PtNi Nanoparticles through Atom Probe Tomography Analysis

| 属性 | 内容 |
|------|------|
| **论文标题** | Exploring the Surface Segregation of Rh Dopant in PtNi Nanoparticles through Atom Probe Tomography Analysis |
| **作者** | Se-Ho Kim, Hosun Jun, Kyuseon Jang, Pyuck-Pa Choi, Baptiste Gault 等 |
| **来源** | arXiv |
| **发表日期** | 2023-03-19 |
| **类别** | cond-mat.mtrl-sci |
...
[原文链接](http://arxiv.org/abs/2303.10548v1)

---

### 8. Catalytic action of two-dimensional layered materials (WS2, and MoS2) on hydrogen sorption properties of MgH2

| 属性 | 内容 |
|------|------|
| **论文标题** | Catalytic action of two-dimensional layered materials (WS2, and MoS2) on hydrogen sorption properties of MgH2 |
| **作者** | S. K. Verma, M. A. Shaz, T. P. Yadav |
| **来源** | arXiv |
| **发表日期** | 2023-01-07 |
| **类别** | cond-mat.mtrl-sci |
...
[原文链接](http://arxiv.org/abs/2301.02897v1)

---

### 9. Comprehensive understanding of H adsorption on MoO3 from systematic ab initio simulations

| 属性 | 内容 |
|------|------|
| **论文标题** | Comprehensive understanding of H adsorption on MoO3 from systematic ab initio simulations |
| **作者** | Yuji Ikeda, Deven Estes, Blazej Grabowski |
| **来源** | arXiv |
| **发表日期** | 2021-11-05 |
| **类别** | cond-mat.mtrl-sci |
...
[原文链接](http://arxiv.org/abs/2111.03569v1)

---

### 10. Plasmonic enhancement of molecular hydrogen dissociation on metallic magnesium nanoclusters

| 属性 | 内容 |
|------|------|
| **论文标题** | Plasmonic enhancement of molecular hydrogen dissociation on metallic magnesium nanoclusters |
| **作者** | Oscar A. Douglas-Gallardo, Connor L. Box, Reinhard J. Maurer |
| **来源** | arXiv |
| **发表日期** | 2021-03-31 |
| **类别** | cond-mat.mtrl-sci |
...
[原文链接](http://arxiv.org/abs/2104.00141v2)

---

## 📊 行业洞察

本报告收录了 新能源/材料 领域 10 篇最新学术论文，主要来源于 arXiv 等学术数据库。

...
| 属性 | 内容 |
|------|------|
| **论文标题** | SceneCritic: A Symbolic Evaluator for 3D Indoor Scene Synthesis |
...
### 2. DySkew: Dynamic Data Redistribution for Skew-Resilient Snowpark UDF Execution

| 属性 | 内容 |
|------|------|
| **论文标题** | DySkew: Dynamic Data Redistribution for Skew-Resilient Snowpark UDF Execution |
| **作者** | Chenwei Xie, Urjeet Shrestha, Corbin McElhanney, Lukas Lorimer, Gopal V 等 |
| **来源** | arXiv |
| **发表日期** | 2026-04-14 |
| **类别** | cs.DC, cs.DB |
...
[原文链接](http://arxiv.org/abs/2604.13034v1)

---

### 3. Conflated Inverse Modeling to Generate Diverse and Temperature-Change Inducing Urban Vegetation Patterns

| 属性 | 内容 |
|------|------|
| **论文标题** | Conflated Inverse Modeling to Generate Diverse and Temperature-Change Inducing Urban Vegetation Patterns |
...
[原文链接](http://arxiv.org/abs/2604.13028v1)

---

### 4. CLAD: Efficient Log Anomaly Detection Directly on Compressed Representations

| 属性 | 内容 |
|------|------|
| **论文标题** | CLAD: Efficient Log Anomaly Detection Directly on Compressed Representations |
...
[原文链接](http://arxiv.org/abs/2604.13024v1)

---

### 5. SpotSound: Enhancing Large Audio-Language Models with Fine-Grained Temporal Grounding

| 属性 | 内容 |
|------|------|
| **论文标题** | SpotSound: Enhancing Large Audio-Language Models with Fine-Grained Temporal Grounding |
| **作者** | Luoyi Sun, Xiao Zhou, Zeqian Li, Ya Zhang, Yanfeng Wang 等 |
| **来源** | arXiv |
| **发表日期** | 2026-04-14 |
| **类别** | cs.SD, cs.MM |
...
[原文链接](http://arxiv.org/abs/2604.13023v1)

---

### 6. Representation geometry shapes task performance in vision-language modeling for CT enterography

| 属性 | 内容 |
|------|------|
| **论文标题** | Representation geometry shapes task performance in vision-language modeling for CT enterography |
...
[原文链接](http://arxiv.org/abs/2604.13021v1)

---

### 7. See, Point, Refine: Multi-Turn Approach to GUI Grounding with Visual Feedback

| 属性 | 内容 |
|------|------|
| **论文标题** | See, Point, Refine: Multi-Turn Approach to GUI Grounding with Visual Feedback |
...
[原文链接](http://arxiv.org/abs/2604.13019v1)

---

### 8. Toward Autonomous Long-Horizon Engineering for ML Research

| 属性 | 内容 |
|------|------|
| **论文标题** | Toward Autonomous Long-Horizon Engineering for ML Research |
| **作者** | Guoxin Chen, Jie Chen, Lei Chen, Jiale Zhao, Fanzhe Meng 等 |
| **来源** | arXiv |
| **发表日期** | 2026-04-14 |
| **类别** | cs.CL |
...
### 9. Rethinking On-Policy Distillation of Large Language Models: Phenomenology, Mechanism, and Recipe

| 属性 | 内容 |
|------|------|
| **论文标题** | Rethinking On-Policy Distillation of Large Language Models: Phenomenology, Mechanism, and Recipe |
| **作者** | Yaxuan Li, Yuxin Zuo, Bingxiang He, Jinqian Zhang, Chaojun Xiao 等 |
| **来源** | arXiv |
| **发表日期** | 2026-04-14 |
...
[原文链接](http://arxiv.org/abs/2604.13016v1)
...
| 属性 | 内容 |
|------|------|
| **论文标题** | Lightning OPD: Efficient Post-Training for Large Reasoning Models with Offline On-Policy Distillation |
...
[原文链接](http://arxiv.org/abs/2604.13010v1)

---

## 📊 行业洞察

本报告收录了 AI/ML 领域 10 篇最新学术论文，主要来源于 arXiv 等学术数据库。
